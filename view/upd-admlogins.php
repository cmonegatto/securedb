...
elseif ($player == 'SQLSRV'):
    ...
    $result= $conn->sql(basename(__FILE__), 
                        "SELECT l.ID_LOGIN
                              ...
                              , CONVERT(VARCHAR(10), l.BEGIN_DATE, 121) + ' '  + convert(VARCHAR(8), l.BEGIN_DATE, 14) as BEGIN_DATE
							  --, format(l.END_DATE,'yyyy/MM/dd HH:mm:ss')	as END_DATE
                              , CONVERT(VARCHAR(10), l.END_DATE, 121) + ' '  + convert(VARCHAR(8), l.END_DATE, 14) as END_DATE
                              , l.FREETOOLS
                              , l.SESSIONS_PER_USER
                              , l.INIT_PLSQL
                              , l.COMMENTS
