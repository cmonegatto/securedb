...
foreach ($result as $key => $value) {
	...
	echo "</tr>";
	echo "<td style='text-align:center'><a href='\loginstools/delete/$id' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\"><i class='fa fa-trash'></i></a></td>";
	echo "<td>".$program."</td>";
	echo "</tr>";
