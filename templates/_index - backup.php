...
<html lang="pt-br">
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-dark">
			<a class="navbar-brand text-white" href="#">2Now</a>
			  ...
			  <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
				  ...
				  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="www.securedb.com.br/users/">Usuários</a>
					<a class="dropdown-item" href="#">Ambientes</a>
					<a class="dropdown-item" href="#">Banco Dados</a>
					<a class="dropdown-item" href="#">Aplicações Bloqueadas </a>
